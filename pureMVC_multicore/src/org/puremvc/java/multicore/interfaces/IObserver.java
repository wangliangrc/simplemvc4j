 ...
 * object with a notification method that should be called when an
 * </code>INotification</code> is broadcast. The Observer then acts as a proxy
 * for notifying the interested object.
 * 
 * <P>
 * Observers can receive <code>Notification</code>s by having their
 * <code>notifyObserver</code> method invoked, passing in an object implementing
 * the <code>INotification</code> interface, such as a subclass of
