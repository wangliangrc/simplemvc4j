...
public interface CookieSpecPNames {
     ...
     * collection elements are of type {@link String} and must be compatible
    ...
    /**
     * Parameter for Cookie header formatting. Defines whether
     * {@link org.apache.http.cookie.Cookie cookies} should be put on a single
     * {@link org.apache.http.Header request header}. If not, each cookie is
     * formatted in a seperate Cookie header.
     * <p>
