...
/**
 * An iterator for {@link String} tokens. This interface is designed as a
 * complement to {@link HeaderElementIterator}, in cases where the items are
 * plain strings rather than full header elements.
 * 
...
public interface TokenIterator extends Iterator {
    ...
    /**
     * Obtains the next token from this iteration. This method should only be
