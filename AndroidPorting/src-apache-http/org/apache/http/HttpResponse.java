...
public interface HttpResponse extends HttpMessage {
    ...
    /**
     * Sets the status line of this response. The reason phrase will be
     * determined based on the current {@link #getLocale locale}.
     * 
     * @param ver
     *            the HTTP version
     * @param code
    ...
    /**
     * Updates the status line of this response with a new status code. The
     * status line can only be updated if it is available. It must have been set
     * either explicitly or in a constructor. <br/>
     * The reason phrase will be updated according to the new status code, based
     * on the current {@link #getLocale locale}. It can be set explicitly using
     * {@link #setReasonPhrase setReasonPhrase}.
     * 
     * @param code
    ...
    /**
     * Updates the status line of this response with a new reason phrase. The
     * status line can only be updated if it is available. It must have been set
     * either explicitly or in a constructor.
     * 
     * @param reason
    ...
    /**
     * Changes the locale of this response. If there is a status line, it's
     * reason phrase will be updated according to the status code and new
     * locale.
     * 
     * @param loc
     *            the new locale
