...
public class BasicHttpEntity extends AbstractHttpEntity {
    ...
    /**
     * Creates a new basic entity. The content is initially missing, the content
     ...
     * 
     * @return the content, if this is the first call to this method since
     *         {@link #setContent setContent} has been called
     * 
     * @throws IllegalStateException
     *             if the content has been obtained before, or has not yet been
     *             provided
     */
     ...
     * 
     * @param len
     *            the number of bytes in the content, or a negative number to
     *            indicate an unknown length
     */
     ...
     * 
     * @param instream
     *            the stream to return with the next call to {@link #getContent
     *            getContent}
     */
