...
/**
 * A wrapping entity that buffers it content if necessary. The buffered entity
 * is always repeatable. If the wrapped entity is repeatable itself, calls are
 * passed through. If the wrapped entity is not repeatable, the content is read
