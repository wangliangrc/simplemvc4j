...
/**
 * Base class for wrapping entities. Keeps a {@link #wrappedEntity
 * wrappedEntity} and delegates all calls to it. Implementations of wrapping
 * entities can derive from this class and need to override only those methods
