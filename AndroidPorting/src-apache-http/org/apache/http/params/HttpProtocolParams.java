...
/**
 * This class implements an adaptor around the {@link HttpParams} interface to
 * simplify manipulation of the HTTP protocol specific parameters. <br/>
 * Note that the <i>implements</i> relation to {@link CoreProtocolPNames} is for
 * compatibility with existing application code only. References to the
 * parameter names should use the interface, not this class.
 * 
...
public final class HttpProtocolParams implements CoreProtocolPNames {
     ...
     *            The charset
     */
    public static void setHttpElementCharset(final HttpParams params,
     ...
     *            The charset
     */
    public static void setContentCharset(final HttpParams params,
            final String charset) {
        if (params == null) {
            throw new IllegalArgumentException(
                    "HTTP parameters may not be null");
     ...
     * 
     * @param version
     *            the {@link ProtocolVersion protocol version}
     */
    public static void setVersion(final HttpParams params,
    ...
    public static void setUserAgent(final HttpParams params,
