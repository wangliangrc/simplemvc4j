...
public interface HttpParams {
     ...
     *         <code>null</code> if the parameter is not set or if it is
     ...
     * parameter is not explicitly set, the default value is returned.
     * 
     * @param name
     *            the parent name.
     * @param defaultValue
     ...
     *            parameter name
     * 
     * @return <tt>true</tt> if the parameter is either not set or set to value
     *         <tt>false</tt>, <tt>false</tt> if it is set to <code>true</code>
     */
