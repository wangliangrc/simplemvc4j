...
/**
 * An adaptor for accessing connection parameters in {@link HttpParams}. <br/>
 * Note that the <i>implements</i> relation to {@link CoreConnectionPNames} is
 * for compatibility with existing application code only. References to the
...
public final class HttpConnectionParams implements CoreConnectionPNames {
    ...
    public static boolean getTcpNoDelay(final HttpParams params) {
        ...
        return params.getBooleanParameter(CoreConnectionPNames.TCP_NODELAY,
                true);
    }
    ...
    public static int getSocketBufferSize(final HttpParams params) {
        ...
        return params.getIntParameter(CoreConnectionPNames.SOCKET_BUFFER_SIZE,
                -1);
    }
    ...
    public static int getConnectionTimeout(final HttpParams params) {
        ...
        return params.getIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT,
                0);
    }
     ...
     *            <tt>false</tt> otherwise.
     */
    public static void setStaleCheckingEnabled(final HttpParams params,
            boolean value) {
        if (params == null) {
            throw new IllegalArgumentException(
                    "HTTP parameters may not be null");
