...
/**
 * {@link HttpParams} implementation that delegates resolution of a parameter to
 * the given default {@link HttpParams} instance if the parameter is not present
 * in the local one. The state of the local collection can be mutated, whereas
 * the default collection is treated as read-only.
 * 
...
public final class DefaultedHttpParams extends AbstractHttpParams {
    ...
    /**
     * Retrieves the value of the parameter from the local collection and, if
     * the parameter is not set locally, delegates its resolution to the default
     * collection.
     */
