...
/**
 * A handler for determining if the given execution context is user specific or
 * not. The token object returned by this handler is expected to uniquely
...
public interface UserTokenHandler {
    ...
    /**
     * The token object returned by this method is expected to uniquely identify
     * the current user if the context is user specific or to be
