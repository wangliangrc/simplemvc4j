...
/**
 * A handler for determining if an HTTP request should be redirected to a new
 * location in response to an HTTP response received from the target server.
 * 
 * <p>
...
public interface RedirectHandler {
    ...
    /**
     * Determines if a request should be redirected to a new location given the
     ...
     * 
     * @return <code>true</code> if the request should be redirected,
     *         <code>false</code> otherwise
     */
    boolean isRedirectRequested(HttpResponse response, HttpContext context);

    /**
     * Determines the location request is expected to be redirected to given the
     * response from the target server and the current request execution
     * context.
     * 
     * @param response
     *            the response received from the target server
