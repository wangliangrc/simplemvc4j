 ...
 * {@link CookieStore} to the request being executed and generates corresponding
...
public class RequestAddCookies implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        CookieSpecRegistry registry = (CookieSpecRegistry) context
                .getAttribute(ClientContext.COOKIESPEC_REGISTRY);
        if (registry == null) {
        ...
        CookieSpec cookieSpec = registry.getCookieSpec(policy,
                request.getParams());
