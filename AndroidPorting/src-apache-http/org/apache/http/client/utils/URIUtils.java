...
public class URIUtils {
     ...
     * 
     * See <a
     * href="https://issues.apache.org/jira/browse/HTTPCLIENT-730">HTTPCLIENT
     * -730</a> for more information.
     * 
     * @param scheme
     *            Scheme name
     * @param host
    ...
    public static URI rewriteURI(final URI uri, final HttpHost target,
        ...
        if (target != null) {
            return URIUtils.createURI(target.getSchemeName(),
                    target.getHostName(), target.getPort(), uri.getRawPath(),
                    uri.getRawQuery(),
                    dropFragment ? null : uri.getRawFragment());
        } else {
            return URIUtils.createURI(null, null, -1, uri.getRawPath(),
                    uri.getRawQuery(),
                    dropFragment ? null : uri.getRawFragment());
        }
    }
