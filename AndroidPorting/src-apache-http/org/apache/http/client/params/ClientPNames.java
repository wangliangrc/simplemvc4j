...
/**
 * Parameter names for the HttpClient module. This does not include parameters
 * for informational units HttpAuth, HttpCookie, or HttpConn.
 * 
...
public interface ClientPNames {
    ...
    /**
     * Defines the factory to create a default
     * {@link org.apache.http.conn.ClientConnectionManager}.
     * <p>
     * This parameters expects a value of type
    ...
    /**
     * Defines the name of the cookie specification to be used for HTTP state
     * management.
     * <p>
     * This parameter expects a value of type {@link String}.
     * </p>
     ...
     * host is not explicitly specified in the request URI.
     * <p>
     * This parameter expects a value of type {@link org.apache.http.HttpHost}.
     * </p>
     */
