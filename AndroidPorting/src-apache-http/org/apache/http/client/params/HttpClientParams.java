...
public class HttpClientParams {
    ...
    public static boolean isAuthenticating(final HttpParams params) {
        ...
        return params.getBooleanParameter(ClientPNames.HANDLE_AUTHENTICATION,
                true);
    }
    ...
    public static String getCookiePolicy(final HttpParams params) {
        ...
        String cookiePolicy = (String) params
    ...
    public static void setCookiePolicy(final HttpParams params,
