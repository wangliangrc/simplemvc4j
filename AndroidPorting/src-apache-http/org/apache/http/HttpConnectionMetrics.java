...
public interface HttpConnectionMetrics {
    ...
    /**
     * Returns the number of requests transferred over the connection, 0 if not
     * available.
     */
    long getRequestCount();

    /**
     * Returns the number of responses transferred over the connection, 0 if not
     * available.
     */
    long getResponseCount();

    /**
     * Returns the number of bytes transferred over the connection, 0 if not
     * available.
     */
     ...
     * 
     * @return the object representing the metric requested, <code>null</code>
