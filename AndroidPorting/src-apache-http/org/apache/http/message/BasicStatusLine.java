...
/**
 * Represents a status line as returned from a HTTP server. See <a
 * href="http://www.ietf.org/rfc/rfc2616.txt">RFC2616</a> section 6.1. This
 * class is immutable and therefore inherently thread safe.
 * 
 * @see HttpStatus
...
public class BasicStatusLine implements StatusLine, Cloneable {
    ...
    public String toString() {
        ...
        return BasicLineFormatter.DEFAULT.formatStatusLine(null, this)
                .toString();
    }
