...
public class BufferedHeader implements FormattedHeader, Cloneable {
    ...
    /**
     * Creates a new header from a buffer. The name of the header will be parsed
     * immediately, the value only if it is accessed.
     * 
     * @param buffer
    ...
    public String getValue() {
        return this.buffer
                .substringTrimmed(this.valuePos, this.buffer.length());
    }
