...
public class BasicHeaderIterator implements HeaderIterator {
    ...
    /**
     * An array of headers to iterate over. Not all elements of this array are
     * necessarily part of the iteration. This array will never be modified by
     * the iterator. Derived implementations are expected to adhere to this
     * restriction.
     */
    ...
    /**
     * The header name to filter by. <code>null</code> to iterate over all
     ...
     * 
     * @param from
     *            one less than the index to consider first, -1 to search for
     *            the first header
     * 
     * @return the index of the next header that matches the filter name, or
     *         negative if there are no more headers
     */
     ...
     * 
     * @return <code>true</code> if the header should be part of the iteration,
     *         <code>false</code> to skip
     */
    protected boolean filterHeader(int index) {
        return (this.headerName == null)
                || this.headerName.equalsIgnoreCase(this.allHeaders[index]
                        .getName());
    }
    ...
    /**
     * Returns the next header. Same as {@link #nextHeader nextHeader}, but not
     * type-safe.
     * 
     * @return the next header in this iteration
     * 
