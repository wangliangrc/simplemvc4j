...
/**
 * Basic implementation for parsing header values into elements. Instances of
 * this class are stateless and thread-safe. Derived classes are expected to
...
public class BasicHeaderValueParser implements HeaderValueParser {
     ...
     * that {@link BasicHeaderValueParser} is not a singleton, there can be many
    ...
    private final static char[] ALL_DELIMITERS = new char[] { PARAM_DELIMITER,
            ELEM_DELIMITER };
     ...
     */
    protected HeaderElement createHeaderElement(final String name,
            final String value, final NameValuePair[] params) {
    ...
    public NameValuePair parseNameValuePair(final CharArrayBuffer buffer,
            final ParserCursor cursor, final char[] delimiters) {
     ...
     */
    protected NameValuePair createNameValuePair(final String name,
            final String value) {
