...
/**
 * Basic implementation for formatting header value elements. Instances of this
 * class are stateless and thread-safe. Derived classes are expected to maintain
 * these properties.
 * 
...
public class BasicHeaderValueFormatter implements HeaderValueFormatter {
     ...
     * that {@link BasicHeaderValueFormatter} is not a singleton, there can be
     * many instances of the class itself and of derived classes. The instance
    ...
    public CharArrayBuffer formatElements(CharArrayBuffer buffer,
            final HeaderElement[] elems, final boolean quote) {
        if (elems == null) {
    ...
    public final static String formatHeaderElement(final HeaderElement elem,
            boolean quote, HeaderValueFormatter formatter) {
        if (formatter == null)
            formatter = BasicHeaderValueFormatter.DEFAULT;
    ...
    public CharArrayBuffer formatHeaderElement(CharArrayBuffer buffer,
            final HeaderElement elem, final boolean quote) {
        if (elem == null) {
            throw new IllegalArgumentException(
    ...
    public CharArrayBuffer formatNameValuePair(CharArrayBuffer buffer,
            final NameValuePair nvp, final boolean quote) {
        if (nvp == null) {
            throw new IllegalArgumentException(
    ...
    /**
     * Actually formats the value of a name-value pair. This does not include a
     * leading = character. Called from {@link #formatNameValuePair
     * formatNameValuePair}.
     * 
     * @param buffer
    ...
    protected void doFormatValue(final CharArrayBuffer buffer,
            final String value, boolean quote) {
     ...
     *            the character to check
     * 
     * @return <code>true</code> if the character is unsafe, <code>false</code>
     *         otherwise
     */
