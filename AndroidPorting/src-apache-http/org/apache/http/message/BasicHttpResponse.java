...
/**
 * Basic implementation of an HTTP response that can be modified. This
 * implementation makes sure that there always is a status line.
 * 
 ...
 * @since 4.0
 */
public class BasicHttpResponse extends AbstractHttpMessage implements
        HttpResponse {
     ...
     *            the status line
     * @param catalog
     *            the reason phrase catalog, or <code>null</code> to disable
     *            automatic reason phrase lookup
     * @param locale
     *            the locale for looking up reason phrases, or <code>null</code>
     *            for the system locale
     */
    public BasicHttpResponse(final StatusLine statusline,
            final ReasonPhraseCatalog catalog, final Locale locale) {
        super();
        if (statusline == null) {
    ...
    /**
     * Creates a response from a status line. The response will not have a
     * reason phrase catalog and use the system default locale.
     * 
     * @param statusline
     *            the status line
     */
    ...
    /**
     * Creates a response from elements of a status line. The response will not
     * have a reason phrase catalog and use the system default locale.
     * 
     * @param ver
     ...
     */
    public BasicHttpResponse(final ProtocolVersion ver, final int code,
            final String reason) {
    ...
    public void setReasonPhrase(String reason) {
        ...
        this.statusline = new BasicStatusLine(
                this.statusline.getProtocolVersion(),
    ...
    /**
     * Looks up a reason phrase. This method evaluates the currently set catalog
     * and locale. It also handles a missing catalog.
     * 
     * @param code
    ...
    protected String getReason(int code) {
        return (this.reasonCatalog == null) ? null : this.reasonCatalog
                .getReason(code, this.locale);
    }
