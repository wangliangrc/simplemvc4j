...
public class BasicLineFormatter implements LineFormatter {
     ...
     * that {@link BasicLineFormatter} is not a singleton, there can be many
     ...
     * 
     * @return the cleared argument buffer if there is one, or a new empty
     *         buffer that can be used for formatting
     */
     ...
     */
    public final static String formatProtocolVersion(
            final ProtocolVersion version, LineFormatter formatter) {
        if (formatter == null)
    ...
    /**
     * Guesses the length of a formatted protocol version. Needed to guess the
     * length of a formatted request or status line.
     * 
     * @param version
     *            the protocol version to format, or <code>null</code>
     * 
     * @return the estimated length of the formatted protocol version, in
     *         characters
     */
     ...
     * 
     * @param buffer
     *            the empty buffer into which to format, never <code>null</code>
     * @param reqline
    ...
    protected void doFormatStatusLine(final CharArrayBuffer buffer,
        ...
        int len = estimateProtocolVersionLen(statline.getProtocolVersion()) + 1 + 3 + 1; // room
                                                                                         // for
                                                                                         // "HTTP/1.1 200 "
