...
/**
 * Interface for parsing header values into elements. Instances of this
 * interface are expected to be stateless and thread-safe.
 * 
 * 
 * <!-- empty lines above to avoid 'svn diff' context problems -->
 * 
 * @version $Revision: 589325 $ $Date: 2007-10-28 03:37:56 -0700 (Sun, 28 Oct
 *          2007) $
 * 
 * @since 4.0
 */
public interface HeaderValueParser {
     ...
     * decomposed into multiple elements. In order to be processed by this
     * parser, such headers must be in the following form:
     * </p>
     * 
     * <pre>
     ...
     * will be stored as the empty {@link String}; if the "=" is also missing
    ...
    /**
     * Parses a single header element. A header element consist of a
     * semicolon-separate list of name=value definitions.
     * 
     * @param buffer
...
/**
     ...
     *            bounds within the buffer for the parsing operation
     * 
     * @return the name-value pair, where the value is <code>null</code> if no
     *         value is specified
     */
