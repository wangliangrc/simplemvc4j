 ...
 * @version $Revision: 604625 $ $Date: 2007-12-16 06:11:11 -0800 (Sun, 16 Dec
 *          2007) $
 * 
 * @since 4.0
 */
public class BasicHeaderElement implements HeaderElement, Cloneable {
     ...
     * @param parameters
     *            header element parameters. May be <tt>null</tt>. Parameters
    ...
    /**
     * Get parameters, if any. The returned array is created for each invocation
     * and can be modified by the caller without affecting this header element.
     * 
