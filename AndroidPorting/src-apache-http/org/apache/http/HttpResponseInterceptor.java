...
/**
 * Processes a response. Provides the ability to process a response before it is
 * sent to the client or after it has been received on the client side.
 * 
...
public interface HttpResponseInterceptor {
    ...
    /**
     * Processes a response. On the server side, this step is performed before
     * the response is sent to the client. On the client side, this step is
