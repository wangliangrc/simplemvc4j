...
public interface HttpResponseFactory {
     ...
     *            the status code
     * @param context
     *            the context from which to determine the locale for looking up
     *            a reason phrase to the status code, or <code>null</code> to
     ...
     * @param context
     *            the context from which to determine the locale for looking up
     *            a reason phrase if the status code is updated, or
