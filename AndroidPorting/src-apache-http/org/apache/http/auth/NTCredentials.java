...
public class NTCredentials implements Credentials {
    ...
    public NTCredentials(String usernamePassword) {
        ...
        if (atSlash >= 0) {
            this.principal = new NTUserPrincipal(username.substring(0, atSlash)
                    .toUpperCase(Locale.ENGLISH),
                    username.substring(atSlash + 1));
        } else {
            this.principal = new NTUserPrincipal(null,
                    username.substring(atSlash + 1));
        }
     ...
     *            The password.
     * @param workstation
     *            The workstation the authentication request is originating
     *            from. Essentially, the computer name for this machine.
     * @param domain
     *            The domain to authenticate within.
     */
    public NTCredentials(final String userName, final String password,
