 ...
 * simplify manipulation of the HTTP authentication specific parameters.
 * 
...
public final class AuthParams {
     ...
     * . If not configured, {@link HTTP#DEFAULT_PROTOCOL_CHARSET
    ...
    public static String getCredentialCharset(final HttpParams params) {
        ...
        String charset = (String) params
                .getParameter(AuthPNames.CREDENTIAL_CHARSET);
     ...
     *            The charset
     */
    public static void setCredentialCharset(final HttpParams params,
