...
public interface HttpMessage {
     ...
     * values are ignored. Headers are orderd in the sequence they will be sent
     * over a connection.
     * 
     * @param name
     ...
     * message the first element of {@link #getHeaders(String)} is returned. If
     * there is no matching header in the message <code>null</code> is returned.
     * 
     * @param name
     *            the name of the header to return.
     * @return the first header whose name property equals <code>name</code> or
     *         <code>null</code> if no such header could be found.
     */
    Header getFirstHeader(String name);

    /**
     * Returns the last header with a specified name of this message. Header
     * values are ignored. If there is more than one matching header in the
     * message the last element of {@link #getHeaders(String)} is returned. If
     * there is no matching header in the message <code>null</code> is returned.
     * 
     * @param name
     *            the name of the header to return.
     * @return the last header whose name property equals <code>name</code>. or
     *         <code>null</code> if no such header could be found.
     */
     ...
     * 
     * @return Iterator that returns Header objects with the argument name in
     *         the sequence they are sent over a connection.
     */
