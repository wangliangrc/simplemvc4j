...
/**
 * An entity that releases a {@link ManagedClientConnection connection}. A
 * {@link ManagedClientConnection} will typically <i>not</i> return a managed
 * entity, but you can replace the unmanaged entity in the response with a
 * managed one.
 * 
...
public class BasicManagedEntity extends HttpEntityWrapper implements
     ...
     * 
     * @param entity
     *            the entity of which to wrap the content. Note that the
     *            argument entity can no longer be used afterwards, since the
     *            content will be taken by this managed entity.
     * @param conn
     *            the connection to release
     * @param reuse
     *            whether the connection should be re-used
     */
    public BasicManagedEntity(HttpEntity entity, ManagedClientConnection conn,
            boolean reuse) {
        super(entity);
    ...
    /**
     * Releases the connection gracefully. The connection attribute will be
     * nullified. Subsequent invocations are no-ops.
     * 
     * @throws IOException
     *             in case of an IO problem. The connection attribute will be
     *             nullified anyway.
     */
