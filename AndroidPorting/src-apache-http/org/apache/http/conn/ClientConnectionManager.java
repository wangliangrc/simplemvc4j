...
public interface ClientConnectionManager {
    ...
    /**
     * Releases a connection for use by others. You may optionally specify how
     * long the connection is valid to be reused. Values <= 0 are considered to
     * be valid forever. If the connection is not marked as reusable, the
     * connection will not be reused regardless of the valid duration.
     * 
     ...
     */
    void releaseConnection(ManagedClientConnection conn, long validDuration,
            TimeUnit timeUnit);

    /**
     * Closes idle connections in the pool. Open connections in the pool that
     * have not been used for the timespan given by the argument will be closed.
     * Currently allocated connections are not subject to this method. Times
     * will be checked with milliseconds precision
     * 
    ...
    /**
     * Shuts down this connection manager and releases allocated resources. This
