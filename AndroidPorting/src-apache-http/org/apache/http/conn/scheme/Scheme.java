 ...
 * Schemes are identified by lowercase names. Supported schemes are typically
 * collected in a {@link SchemeRegistry SchemeRegistry}.
 * 
 * <p>
 * For example, to configure support for "https://" URLs, you could write code
 * like the following:
 * </p>
 * 
 * <pre>
...
public final class Scheme {
    ...
    /**
     * Creates a new scheme. Whether the created scheme allows for layered
     * connections depends on the class of <code>factory</code>.
     * 
     * @param name
     *            the scheme name, for example "http". The name will be
     *            converted to lowercase.
     * @param factory
     *            the factory for creating sockets for communication with this
     *            scheme
     * @param port
     *            the default port for this scheme
     */
    ...
    /**
     * Obtains the socket factory. If this scheme is {@link #isLayered layered},
     * the factory implements {@link LayeredSocketFactory LayeredSocketFactory}.
     * 
    ...
    /**
     * Resolves the correct port for this scheme. Returns the given port if it
     * is valid, the default port otherwise.
     * 
     * @param port
     *            the port to be resolved, a negative number to obtain the
     *            default port
     * 
    ...
    public final boolean equals(Object obj) {
        ...
        Scheme s = (Scheme) obj;
        return (name.equals(s.name) && defaultPort == s.defaultPort
                && layered == s.layered && socketFactory
                    .equals(s.socketFactory));
    } // equals
