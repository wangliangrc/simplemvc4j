 ...
 * failure, provided the same hostname resolves to multiple {@link InetAddress}
 * es. Please note the
 * {@link #connectSocket(Socket, String, int, InetAddress, int, HttpParams)}
...
public final class MultihomePlainSocketFactory implements SocketFactory {
    ...
    /**
     * Compares this factory with an object. There is only one instance of this
     * class.
     * 
     * @param obj
    ...
    /**
     * Obtains a hash code for this object. All instances of this class have the
     * same hash code. There is only one instance of this class.
     */
    @Override
    public int hashCode() {
