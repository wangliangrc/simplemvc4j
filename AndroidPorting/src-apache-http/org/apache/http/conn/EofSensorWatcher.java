...
/**
 * A watcher for {@link EofSensorInputStream EofSensorInputStream}. Each stream
 * will notify it's watcher at most once.
 * 
...
public interface EofSensorWatcher {
    ...
    /**
     * Indicates that the {@link EofSensorInputStream stream} is closed. This
     * method will be called only if EOF was <i>not</i> detected before closing.
    ...
    /**
     * Indicates that the {@link EofSensorInputStream stream} is aborted. This
     * method will be called only if EOF was <i>not</i> detected before
     * aborting. Otherwise, {@link #eofDetected eofDetected} is called.
     * <p/>
