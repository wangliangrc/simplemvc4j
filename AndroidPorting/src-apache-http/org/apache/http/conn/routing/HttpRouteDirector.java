...
/**
 * Provides directions on establishing a route. Implementations of this
 * interface compare a planned route with a tracked route and indicate the next
 * step required.
 * 
...
public interface HttpRouteDirector {
     ...
     *            the planned route
     * @param fact
     *            the currently established route, or <code>null</code> if
     *            nothing is established
     * 
     * @return one of the constants defined in this interface, indicating either
     *         the next step to perform, or success, or failure. 0 is for
     *         success, a negative value for failure.
     */
