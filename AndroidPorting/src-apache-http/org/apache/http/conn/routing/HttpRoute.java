...
/**
 * The route for a request. Instances of this class are unmodifiable and
 * therefore suitable for use as lookup keys.
 * 
...
public final class HttpRoute implements RouteInfo, Cloneable {
    ...
    /**
     * The local address to connect from. <code>null</code> indicates that the
    ...
    /**
     * Internal, fully-specified constructor. This constructor does <i>not</i>
     * clone the proxy chain array, nor test it for <code>null</code> elements.
     * This conversion and check is the responsibility of the public
     * constructors. The order of arguments here is different from the similar
     * public constructor, as required by Java.
     * 
     * @param local
     *            the local address to route from, or <code>null</code> for the
     *            default
     * @param target
     *            the host to which to route
     * @param proxies
     *            the proxy chain to use, or <code>null</code> for a direct
     *            route
     * @param secure
     *            <code>true</code> if the route is (to be) secure,
     *            <code>false</code> otherwise
     * @param tunnelled
     *            the tunnel type of this route, or <code>null</code> for PLAIN
     * @param layered
     *            the layering type of this route, or <code>null</code> for
     *            PLAIN
     */
     ...
     *            default
     * @param proxy
     *            the proxy to use, or <code>null</code> for a direct route
     * @param secure
     *            <code>true</code> if the route is (to be) secure,
     *            <code>false</code> otherwise
     * @param tunnelled
     *            <code>true</code> if the route is (to be) tunnelled via the
     *            proxy, <code>false</code> otherwise
     * @param layered
     *            <code>true</code> if the route includes a layered protocol,
     *            <code>false</code> otherwise
     */
    ...
    /**
     * Creates a new route through a proxy. When using this constructor, the
     * <code>proxy</code> MUST be given. For convenience, it is assumed that a
     * secure connection will be layered over a tunnel through the proxy.
     * 
     * @param target
     *            the host to which to route
     * @param local
    ...
    /**
     * Helper to duplicate and check a proxy chain. An empty proxy chain is
     * converted to <code>null</code>.
     * 
     * @param proxies
     *            the proxy chain to duplicate, or <code>null</code>
     * 
    ...
    public final HttpHost getHopTarget(int hop) {
        ...
        if (hop >= hopcount)
            throw new IllegalArgumentException("Hop index " + hop
    ...
    public final boolean equals(Object o) {
        ...
        equal &= (this.localAddress == that.localAddress)
                || ((this.localAddress != null) && this.localAddress
                        .equals(that.localAddress));
        equal &= (this.proxyChain == that.proxyChain)
                || ((this.proxyChain != null) && (that.proxyChain != null) && (this.proxyChain.length == that.proxyChain.length));
        // comparison of actual proxies follows below
        equal &= (this.secure == that.secure)
