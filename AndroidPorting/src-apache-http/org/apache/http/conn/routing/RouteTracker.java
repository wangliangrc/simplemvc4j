...
public final class RouteTracker implements RouteInfo, Cloneable {
    ...
    /**
     * Creates a new route tracker. The target and origin need to be specified
     * at creation time.
     * 
     * @param target
    ...
    /**
     * Creates a new tracker for the given route. Only target and origin are
     * taken from the route, everything else remains to be tracked.
     * 
     * @param route
     *            the route to track
     */
     ...
     * 
     * @param secure
     *            <code>true</code> if the route is secure, <code>false</code>
     *            otherwise
     */
    ...
    /**
     * Tracks tunnelling to a proxy in a proxy chain. This will extend the
     * tracked proxy chain, but it does not mark the route as tunnelled. Only
     * end-to-end tunnels are considered there.
     * 
     * @param proxy
    ...
    /**
     * Obtains the tracked route. If a route has been tracked, it is
     * {@link #isConnected connected}. If not connected, nothing has been
     * tracked so far.
     * 
     * @return the tracked route, or <code>null</code> if nothing has been
     *         tracked so far
     */
    public final HttpRoute toRoute() {
        return !this.connected ? null : new HttpRoute(this.targetHost,
                this.localAddress, this.proxyChain, this.secure,
    ...
    public final boolean equals(Object o) {
        ...
        equal &= (this.connected == that.connected)
    ...
    /**
     * Generates a hash code for this tracked route. Route trackers are
     * modifiable and should therefore not be used as lookup keys. Use
     * {@link #toRoute toRoute} to obtain an unmodifiable representation of the
     * tracked route.
     * 
