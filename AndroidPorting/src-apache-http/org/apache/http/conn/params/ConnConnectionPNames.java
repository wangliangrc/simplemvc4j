...
public interface ConnConnectionPNames {
     ...
     * than specified). Unfortunately, in some cases, this cannot be detected
     * after the bad response, but only before the next one. So HttpClient must
     * be able to skip those surplus lines this way.
     * </p>
     * <p>
     * This parameter expects a value of type {@link Integer}. 0 disallows all
     * garbage/empty lines before the status line. Use
     * {@link java.lang.Integer#MAX_VALUE} for unlimited (default in lenient
     * mode).
     * </p>
     */
