...
public interface ConnRoutePNames {
    ...
    /**
     * Parameter for the default proxy. The default value will be used by some
     ...
     * interfaces, this parameter can be used to select the network interface
     * from which the connection originates. It will be interpreted by the
     * standard {@link org.apache.http.conn.routing.HttpRoutePlanner
     * HttpRoutePlanner} implementations, in particular the default
     * implementation.
     * <p>
    ...
    /**
     * Parameter for an forced route. The forced route will be interpreted by
     * the standard {@link org.apache.http.conn.routing.HttpRoutePlanner
     * HttpRoutePlanner} implementations. Instead of computing a route, the
     * given forced route will be returned, even if it points to the wrong
     * target host.
     * <p>
