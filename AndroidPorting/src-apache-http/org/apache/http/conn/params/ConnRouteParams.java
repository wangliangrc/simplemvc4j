...
/**
 * An adaptor for accessing route related parameters in {@link HttpParams}. See
 * {@link ConnRoutePNames} for parameter name definitions.
 * 
...
public class ConnRouteParams implements ConnRoutePNames {
    ...
    /**
     * A special value indicating "no host". This relies on a nonsense scheme
     * name to avoid conflicts with actual hosts. Note that this is a
     * <i>valid</i> host.
     */
    public static final HttpHost NO_HOST = new HttpHost("127.0.0.255", 0,
            "no-host");

    /**
     * A special value indicating "no route". This is a route with
     * {@link #NO_HOST} as the target.
     */
    ...
    /**
     * Obtains the {@link ConnRoutePNames#DEFAULT_PROXY DEFAULT_PROXY} parameter
     * value. {@link #NO_HOST} will be mapped to <code>null</code>, to allow
     * unsetting in a hierarchy.
     * 
     * @param params
    ...
    /**
     * Sets the {@link ConnRoutePNames#DEFAULT_PROXY DEFAULT_PROXY} parameter
     * value.
     * 
     * @param params
     *            the parameters in which to set the value
     * @param proxy
     *            the value to set, may be <code>null</code>. Note that
     *            {@link #NO_HOST} will be mapped to <code>null</code> by
     *            {@link #getDefaultProxy}, to allow for explicit unsetting in
     *            hierarchies.
     */
    ...
    /**
     * Obtains the {@link ConnRoutePNames#FORCED_ROUTE FORCED_ROUTE} parameter
     * value. {@link #NO_ROUTE} will be mapped to <code>null</code>, to allow
     * unsetting in a hierarchy.
     * 
     * @param params
     *            the parameters in which to look up
    ...
    /**
     * Sets the {@link ConnRoutePNames#FORCED_ROUTE FORCED_ROUTE} parameter
     * value.
     * 
     * @param params
     *            the parameters in which to set the value
     * @param route
     *            the value to set, may be <code>null</code>. Note that
     *            {@link #NO_ROUTE} will be mapped to <code>null</code> by
     *            {@link #getForcedRoute}, to allow for explicit unsetting in
     *            hierarchies.
     */
    ...
    /**
     * Obtains the {@link ConnRoutePNames#LOCAL_ADDRESS LOCAL_ADDRESS} parameter
     * value. There is no special value that would automatically be mapped to
    ...
    public static InetAddress getLocalAddress(HttpParams params) {
        ...
        InetAddress local = (InetAddress) params.getParameter(LOCAL_ADDRESS);
        // no explicit unsetting
        return local;
    }

    /**
     * Sets the {@link ConnRoutePNames#LOCAL_ADDRESS LOCAL_ADDRESS} parameter
     * value.
     * 
     * @param params
     *            the parameters in which to set the value
