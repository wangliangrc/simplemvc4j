 ...
 * client-side {@link org.apache.http.conn.ClientConnectionManager connection
 * managers}.
 * 
...
public final class ConnManagerParams implements ConnManagerPNames {
     ...
     *            HTTP parameters
     * @param connPerRoute
     *            lookup interface for maximum number of connections allowed per
     *            route
     * 
    ...
    /**
     * Returns lookup interface for maximum number of connections allowed per
     * route.
     * 
     * @param params
     *            HTTP parameters
     * 
     * @return lookup interface for maximum number of connections allowed per
     *         route.
     * 
     * @see ConnManagerPNames#MAX_CONNECTIONS_PER_ROUTE
     */
    public static ConnPerRoute getMaxConnectionsPerRoute(final HttpParams params) {
        ...
        ConnPerRoute connPerRoute = (ConnPerRoute) params
                .getParameter(MAX_CONNECTIONS_PER_ROUTE);
     ...
     */
    public static void setMaxTotalConnections(final HttpParams params,
    ...
    public static int getMaxTotalConnections(final HttpParams params) {
        ...
        return params.getIntParameter(MAX_TOTAL_CONNECTIONS,
