...
/**
 * Provides access to an ordered list of request interceptors. Lists are
...
public interface HttpRequestInterceptorList {
    ...
    /**
     * Sets the request interceptors in this list. This list will be cleared and
     * re-initialized to contain all request interceptors from the argument
     * list. If the argument list includes elements that are not request
