...
/**
 * Maintains a map of objects keyed by a request URI pattern. Instances can be
 * looked up by request URI.<br/>
...
public class UriPatternMatcher {
    ...
    public void register(final String pattern, final Object handler) {
        if (pattern == null) {
            throw new IllegalArgumentException(
                    "URI request pattern may not be null");
        }
        if (handler == null) {
            throw new IllegalArgumentException(
                    "HTTP request handelr may not be null");
        }
    ...
    public void setHandlers(final Map map) {
        if (map == null) {
            throw new IllegalArgumentException(
                    "Map of handlers may not be null");
        }
    ...
    public Object lookup(String requestURI) {
        ...
        if (handler == null) {
            ...
            for (Iterator it = this.handlerMap.keySet().iterator(); it
                    .hasNext();) {
