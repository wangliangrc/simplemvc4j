...
/**
 * Provides access to an ordered list of response interceptors. Lists are
 * expected to be built upfront and used read-only afterwards for
 * {@link HttpProcessor processing}.
 * 
...
public interface HttpResponseInterceptorList {
     ...
     * 
     * @return the interceptor at the given index, or <code>null</code> if the
    ...
    /**
     * Sets the response interceptors in this list. This list will be cleared
     * and re-initialized to contain all response interceptors from the argument
     * list. If the argument list includes elements that are not response
