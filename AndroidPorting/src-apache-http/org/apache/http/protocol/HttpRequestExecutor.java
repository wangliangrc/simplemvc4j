...
/**
 * Sends HTTP requests and receives the responses. Takes care of request
 * preprocessing and response postprocessing by the respective interceptors.
 * 
...
public class HttpRequestExecutor {
    ...
    /**
     * Decide whether a response comes with an entity. The implementation in
     * this class is based on RFC 2616. Unknown methods and response codes are
     * supposed to indicate responses with an entity. <br/>
     * Derived executors can override this method to handle methods and response
     * codes not specified in RFC 2616.
     * 
     * @param request
    ...
    public void preProcess(final HttpRequest request,
            final HttpProcessor processor, final HttpContext context)
    ...
    /**
     * Send a request over a connection. This method also handles the
     * expect-continue handshake if necessary. If it does not have to handle an
     * expect-continue handshake, it will not use the connection for reading or
     * anything else that depends on data coming in over the connection.
     * 
     * @param request
    ...
    protected HttpResponse doSendRequest(final HttpRequest request,
        ...
        if (request instanceof HttpEntityEnclosingRequest) {
            ...
            final ProtocolVersion ver = request.getRequestLine()
                    .getProtocolVersion();
    ...
    /**
     * Wait for and receive a response. This method will automatically ignore
     * intermediate responses with status code 1xx.
     * 
     * @param request
    ...
    /**
     * Finish a response. This includes post-processing of the response object.
     * It does <i>not</i> read the response entity, if any. It does <i>not</i>
     * allow for immediate re-use of the connection over which the response is
     * coming in.
     * 
     * @param response
