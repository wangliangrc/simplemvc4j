...
public class HttpService {
     ...
     */
    public HttpService(final HttpProcessor proc,
    ...
    public void handleRequest(final HttpServerConnection conn,
        ...
        try {
            ...
            if (response == null) {
                ...
                response.setParams(new DefaultedHttpParams(
                        response.getParams(), this.params));
    ...
    protected void doService(final HttpRequest request,
