 ...
 * @since 4.0
 */
public abstract class AbstractHttpClientConnection implements
    ...
    protected void init(final SessionInputBuffer inbuffer,
            final SessionOutputBuffer outbuffer, final HttpParams params) {
        if (inbuffer == null) {
        ...
        this.responseParser = createResponseParser(inbuffer,
                createHttpResponseFactory(), params);
        this.requestWriter = createRequestWriter(outbuffer, params);
        this.metrics = new HttpConnectionMetricsImpl(inbuffer.getMetrics(),
    ...
    public void sendRequestEntity(final HttpEntityEnclosingRequest request)
        ...
        this.entityserializer.serialize(this.outbuffer, request,
                request.getEntity());
    }
    ...
    public void receiveResponseEntity(final HttpResponse response)
        ...
        assertOpen();
        HttpEntity entity = this.entitydeserializer.deserialize(this.inbuffer,
                response);
