...
public class NetscapeDraftHeaderParser {
    ...
    public HeaderElement parseHeader(final CharArrayBuffer buffer,
        ...
        NameValuePair nvp = this.nvpParser.parseNameValuePair(buffer, cursor,
                DELIMITERS);
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        while (!cursor.atEnd()) {
            NameValuePair param = this.nvpParser.parseNameValuePair(buffer,
                    cursor, DELIMITERS);
            params.add(param);
        }
