...
/**
 * Cookie specification that strives to closely mimic (mis)behavior of common
 * web browser applications such as Microsoft Internet Explorer and Mozilla
 * FireFox.
 * 
...
public class BrowserCompatSpec extends CookieSpecBase {
    ...
    protected static final String[] DATE_PATTERNS = new String[] {
            ...
            DateUtils.PATTERN_ASCTIME, "EEE, dd-MMM-yyyy HH:mm:ss z",
    ...
    public BrowserCompatSpec(final String[] datepatterns) {
        ...
        registerAttribHandler(ClientCookie.MAX_AGE_ATTR,
                new BasicMaxAgeHandler());
        registerAttribHandler(ClientCookie.SECURE_ATTR,
                new BasicSecureHandler());
        registerAttribHandler(ClientCookie.COMMENT_ATTR,
    ...
    public List<Cookie> parse(final Header header, final CookieOrigin origin)
        ...
        if (i1 != -1) {
            ...
            try {
                DateUtils.parseDate(headervalue.substring(i1, i2),
                        this.datepatterns);
