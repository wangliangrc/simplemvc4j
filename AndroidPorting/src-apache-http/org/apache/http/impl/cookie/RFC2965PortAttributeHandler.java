...
public class RFC2965PortAttributeHandler implements CookieAttributeHandler {
    ...
    /**
     * Validate cookie port attribute. If the Port attribute was specified in
     * header, the request port must be in cookie's port list.
     */
    public void validate(final Cookie cookie, final CookieOrigin origin)
        ...
        if (cookie instanceof ClientCookie
                && ((ClientCookie) cookie)
                        .containsAttribute(ClientCookie.PORT_ATTR)) {
    ...
    /**
     * Match cookie port attribute. If the Port attribute is not specified in
     * header, the cookie can be sent to any port. Otherwise, the request port
