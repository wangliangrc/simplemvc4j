...
public class NetscapeDraftSpec extends CookieSpecBase {
     ...
     * </p>
     * 
     * @see <a href="http://wp.netscape.com/newsref/std/cookie_spec.html"> The
     *      Cookie Spec.</a>
     * 
     * @param header
    ...
    public List<Cookie> parse(final Header header, final CookieOrigin origin)
        ...
        if (header instanceof FormattedHeader) {
            ...
            cursor = new ParserCursor(((FormattedHeader) header).getValuePos(),
                    buffer.length());
        } else {
        ...
        return parse(
                new HeaderElement[] { parser.parseHeader(buffer, cursor) },
                origin);
    }
