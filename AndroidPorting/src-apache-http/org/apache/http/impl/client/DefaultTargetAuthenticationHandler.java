 ...
 */
public class DefaultTargetAuthenticationHandler extends
    ...
    public boolean isAuthenticationRequested(final HttpResponse response,
    ...
    public Map<String, Header> getChallenges(final HttpResponse response,
