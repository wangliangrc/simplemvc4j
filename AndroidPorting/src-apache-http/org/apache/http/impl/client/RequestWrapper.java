 ...
 * properties of the current request without modifying the original object. </p>
 * This class is also capable of resetting the request headers to the state of
 ...
 * @since 4.0
 */
public class RequestWrapper extends AbstractHttpMessage implements
        HttpUriRequest {
