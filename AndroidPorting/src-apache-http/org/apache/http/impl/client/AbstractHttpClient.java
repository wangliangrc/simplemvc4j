...
public abstract class AbstractHttpClient implements HttpClient {
     ...
     *            the parameters
     */
    protected AbstractHttpClient(final ClientConnectionManager conman,
    ...
    /**
     * Replaces the parameters. The implementation here does not update
     * parameters of dependent objects.
     * 
     * @param params
    ...
    public synchronized void setAuthSchemes(
    ...
    public synchronized void setCookieSpecs(
    ...
    public synchronized void setReuseStrategy(
    ...
    public synchronized void setKeepAliveStrategy(
    ...
    public synchronized void setHttpRequestRetryHandler(
    ...
    public synchronized void setCredentialsProvider(
    ...
    public synchronized void setUserTokenHandler(
     ...
     * execute(target, request, context)}. The target is determined from the URI
     * of the request.
     * 
     * @param request
     *            the request to execute
     * @param context
     *            the request-specific execution context, or <code>null</code>
    ...
    public final HttpResponse execute(HttpHost target, HttpRequest request,
        ...
        synchronized (this) {
            ...
            director = createClientRequestDirector(getRequestExecutor(),
                    getConnectionManager(), getConnectionReuseStrategy(),
                    getConnectionKeepAliveStrategy(), getRoutePlanner(),
                    getHttpProcessor().copy(), getHttpRequestRetryHandler(),
                    getRedirectHandler(), getTargetAuthenticationHandler(),
                    getProxyAuthenticationHandler(), getUserTokenHandler(),
    ...
    /**
     * Obtains parameters for executing a request. The default implementation in
     * this class creates a new {@link ClientParamsStack} from the request
     * parameters and the client parameters. <br/>
     * This method is called by the default implementation of
     * {@link #execute(HttpHost,HttpRequest,HttpContext)} to obtain the
     * parameters for the {@link DefaultRequestDirector}.
     * 
     * @param req
        ...
        try {
            ...
            if (entity != null) {
                try {
                    ...
                    this.log.warn(
                            "Error consuming content after an exception.", t2);
                }
            }
