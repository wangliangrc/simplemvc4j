...
/**
 * Default implementation of an HTTP client. <br/>
...
public class DefaultHttpClient extends AbstractHttpClient {
        ...
        if (factory == null) { // then try getting its class name.
            ...
            if (className != null) {
                try {
                    ...
                    factory = (ClientConnectionManagerFactory) clazz
                            .newInstance();
    ...
    protected HttpRoutePlanner createHttpRoutePlanner() {
        ...
        return new ProxySelectorRoutePlanner(getConnectionManager()
                .getSchemeRegistry(), null);
        // END android-changed
    }
