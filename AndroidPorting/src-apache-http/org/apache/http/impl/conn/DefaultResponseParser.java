...
public class DefaultResponseParser extends AbstractMessageParser {
    ...
    public DefaultResponseParser(final SessionInputBuffer buffer,
            final LineParser parser, final HttpResponseFactory responseFactory,
        ...
        this.maxGarbageLines = params
                .getIntParameter(ConnConnectionPNames.MAX_STATUS_LINE_GARBAGE,
                        Integer.MAX_VALUE);
    }
    ...
    protected HttpMessage parseHead(final SessionInputBuffer sessionBuffer)
        ...
        StatusLine statusline = lineParser
                .parseStatusLine(this.lineBuf, cursor);
