 ...
 * based on {@link org.apache.http.conn.params.ConnRoutePNames parameters}. It
 * will not make use of any Java system properties, nor of system or browser
 * proxy settings.
 */
public class DefaultHttpRoutePlanner implements HttpRoutePlanner {
    ...
    public HttpRoute determineRoute(HttpHost target, HttpRequest request,
        ...
        final InetAddress local = ConnRouteParams.getLocalAddress(request
                .getParams());
        final HttpHost proxy = ConnRouteParams.getDefaultProxy(request
                .getParams());
