 ...
 * {@link org.apache.http.conn.ManagedClientConnection managed} client
 * connections. The connection in the pool entry is used to initialize the base
 * class. In addition, methods to establish a route are delegated to the pool
 * entry. {@link #shutdown shutdown} and {@link #close close} will clear the
 * tracked route in the pool entry and call the respective method of the wrapped
 * connection.
 * 
 ...
 * @version $Revision: 658775 $ $Date: 2008-05-21 10:30:45 -0700 (Wed, 21 May
 *          2008) $
 * 
 * @since 4.0
 */
public abstract class AbstractPooledConnAdapter extends
