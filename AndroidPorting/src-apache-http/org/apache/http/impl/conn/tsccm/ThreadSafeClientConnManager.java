 ...
 * <p>
 * This class is derived from <code>MultiThreadedHttpConnectionManager</code> in
...
public class ThreadSafeClientConnManager implements ClientConnectionManager {
    ...
    public ClientConnectionRequest requestConnection(final HttpRoute route,
        ...
        return new ClientConnectionRequest() {
            ...
            public ManagedClientConnection getConnection(long timeout,
                ...
                return new BasicPooledConnAdapter(
                        ThreadSafeClientConnManager.this, entry);
            }
    ...
    /**
     * Gets the total number of pooled connections for the given route. This is
     * the total number of connections that have been created and are still in
     * use by this connection manager for the route. This value will not exceed
     ...
     * connection manager. This value will not exceed the maximum number of
