...
public class BasicPoolEntry extends AbstractPoolEntry {
    ...
    /**
     * A weak reference to <code>this</code> used to detect GC of entries. Pool
     * entries can only be GCed when they are allocated by an application and
     * therefore not referenced with a hard link in the manager.
     */
     ...
     * @param queue
     *            the reference queue for tracking GC of this entry, or
     *            <code>null</code>
     */
