...
/**
 * A weak reference to a {@link BasicPoolEntry BasicPoolEntry}. This reference
 * explicitly keeps the planned route, so the connection can be reclaimed if it
 * is lost to garbage collection.
 */
public class BasicPoolEntryRef extends WeakReference<BasicPoolEntry> {
     ...
     * 
     * @param entry
     *            the pool entry, must not be <code>null</code>
     * @param queue
     *            the reference queue, or <code>null</code>
     */
    ...
    /**
     * Obtain the planned route for the referenced entry. The planned route is
     * still available, even if the entry is gone.
     * 
