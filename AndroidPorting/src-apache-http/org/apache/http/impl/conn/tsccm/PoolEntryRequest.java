...
public interface PoolEntryRequest {
    ...
    /**
     * Obtains a pool entry with a connection within the given timeout. If
     * {@link #abortRequest()} is called before this completes an
     ...
     *             if the calling thread was interrupted or the request was
     *             aborted
     */
