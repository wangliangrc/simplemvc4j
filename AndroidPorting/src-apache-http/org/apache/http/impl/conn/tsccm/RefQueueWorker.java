...
/**
 * A worker thread for processing queued references. {@link Reference Reference}
 * s can be {@link ReferenceQueue queued} automatically by the garbage
 * collector. If that feature is used, a daemon thread should be executing this
 * worker. It will pick up the queued references and pass them on to a handler
...
public class RefQueueWorker implements Runnable {
    ...
    /**
     * The thread executing this handler. This attribute is also used as a
     * shutdown indicator.
     */
    ...
    /**
     * The main loop of this worker. If initialization succeeds, this method
     * will only return after {@link #shutdown shutdown()}. Only one thread can
    ...
    /**
     * Shuts down this worker. It can be re-started afterwards by another call
     * to {@link #run run()}.
     */
