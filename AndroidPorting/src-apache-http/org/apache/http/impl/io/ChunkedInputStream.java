...
/**
 * Implements chunked transfer coding. See <a
 * href="http://www.w3.org/Protocols/rfc2616/rfc2616.txt">RFC 2616</a>, <a
 * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.6">section
 * 3.6.1</a>. It transparently coalesces chunks of a HTTP stream that uses
 * chunked transfer coding. After the stream is read to the end, it provides
 * access to the trailers, if any.
 * <p>
...
public class ChunkedInputStream extends InputStream {
    ...
    private int getChunkSize() throws IOException {
        ...
        try {
            return Integer.parseInt(this.buffer.substringTrimmed(0, separator),
                    16);
    ...
    private void parseTrailerHeaders() throws IOException {
        try {
            ...
            IOException ioe = new MalformedChunkCodingException(
                    "Invalid footer: " + e.getMessage());
     ...
     *             If an IO problem occurs
     */
    static void exhaustInputStream(final InputStream inStream)
            throws IOException {
