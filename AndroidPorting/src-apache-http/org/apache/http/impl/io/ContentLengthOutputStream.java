...
public class ContentLengthOutputStream extends OutputStream {
     ...
     * @param contentLength
     *            The maximum number of bytes that can be written to the stream.
     *            Subsequent write operations will be ignored.
     * 
     * @since 4.0
     */
    public ContentLengthOutputStream(final SessionOutputBuffer out,
            long contentLength) {
        super();
        if (out == null) {
