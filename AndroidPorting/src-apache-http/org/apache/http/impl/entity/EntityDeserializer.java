 ...
 * <p>
 * This entity deserializer currently supports only "chunked" and "identitiy"
 * transfer-coding</a>
 * </p>
 * 
...
public class EntityDeserializer {
    ...
    protected BasicHttpEntity doDeserialize(final SessionInputBuffer inbuffer,
        ...
        Header contentEncodingHeader = message
    ...
    public HttpEntity deserialize(final SessionInputBuffer inbuffer,
            final HttpMessage message) throws HttpException, IOException {
        if (inbuffer == null) {
            throw new IllegalArgumentException(
