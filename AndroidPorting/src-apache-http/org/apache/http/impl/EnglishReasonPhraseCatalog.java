...
/**
 * English reason phrases for HTTP status codes. All status codes defined in
...
public class EnglishReasonPhraseCatalog implements ReasonPhraseCatalog {
    ...
    /**
     * The default instance of this catalog. This catalog is thread safe, so
     * there typically is no need to create other instances.
     */
    public final static EnglishReasonPhraseCatalog INSTANCE = new EnglishReasonPhraseCatalog();

    /**
     * Restricted default constructor, for derived classes. If you need an
     * instance of this class, use {@link #INSTANCE INSTANCE}.
     */
    ...
    /**
     * Stores the given reason phrase, by status code. Helper method to
