...
public class DefaultHttpResponseFactory implements HttpResponseFactory {
    ...
    /**
     * Creates a new response factory with the default catalog. The default
     * catalog is {@link EnglishReasonPhraseCatalog EnglishReasonPhraseCatalog}.
     */
    ...
    public HttpResponse newHttpResponse(final ProtocolVersion ver,
            final int status, HttpContext context) {
        if (ver == null) {
    ...
    /**
     * Determines the locale of the response. The implementation in this class
