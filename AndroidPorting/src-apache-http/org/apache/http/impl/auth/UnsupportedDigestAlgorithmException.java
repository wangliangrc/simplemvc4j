...
public class UnsupportedDigestAlgorithmException extends RuntimeException {
    ...
    /**
     * Creates a new UnsupportedAuthAlgoritmException with a <tt>null</tt>
     * detail message.
     */
    ...
    /**
     * Creates a new UnsupportedAuthAlgoritmException with the specified
     * message.
     * 
     * @param message
    ...
    /**
     * Creates a new UnsupportedAuthAlgoritmException with the specified detail
     * message and cause.
     * 
     * @param message
     *            the exception detail message
