...
/**
 * Abstract NTLM authentication engine. The engine can be used to generate Type1
 * messages and Type3 messages in response to a Type2 challenge.
 * <p/>
 * For details see <a href="http://davenport.sourceforge.net/ntlm.html">this
 * resource</a>
 * 
...
public interface NTLMEngine {
     ...
     * 
     * @param domain
     *            Optional Windows domain name. Can be <code>null</code>.
     * @param workstation
     *            Optional Windows workstation name. Can be <code>null</code>.
     ...
     * @throws NTLMEngineException
     */
    String generateType3Msg(String username, String password, String domain,
