...
public class SocketHttpClientConnection extends AbstractHttpClientConnection
    ...
    protected void bind(final Socket socket, final HttpParams params)
            throws IOException {
        if (socket == null) {
        ...
        init(createSessionInputBuffer(socket, buffersize, params),
                createSessionOutputBuffer(socket, buffersize, params), params);
    ...
    public void setSocketTimeout(int timeout) {
        ...
        if (this.socket != null) {
            try {
                ...
                // It is not quite clear from the Sun's documentation if there
                // are any
                // other legitimate cases for a socket exception to be thrown
                // when setting
