...
// Accessible but not supported in GWT.
final class Serialization {
    ...
    @GwtIncompatible("java.io.ObjectInputStream")
    public static <K, V> void populateMap(Map<K, V> map,
            ObjectInputStream stream, int size) throws IOException,
            ClassNotFoundException {
    ...
    @GwtIncompatible("java.io.ObjectInputStream")
    public static <E> void populateMultiset(Multiset<E> multiset,
            ObjectInputStream stream, int distinctElements) throws IOException,
            ClassNotFoundException {
    ...
    @GwtIncompatible("java.io.ObjectInputStream")
    public static <K, V> void populateMultimap(Multimap<K, V> multimap,
            ObjectInputStream stream, int distinctKeys) throws IOException,
            ClassNotFoundException {
    ...
    static <T> FieldSetter<T> getFieldSetter(final Class<T> clazz,
            String fieldName) {
        try {
