 ...
 * {
 *     &#064;code
 *     ConcurrentMap&lt;Key, Graph&gt; graphs = new MapMaker().concurrencyLevel(32)
 *             .softKeys().weakValues().expiration(30, TimeUnit.MINUTES)
...
public final class MapMaker {
     ...
     * an object of a type other than {@code K} can result in that object being
        ...
        WEAK {
            ...
            <K, V> ReferenceEntry<K, V> copyEntry(K key,
                ...
                return (newNext == null) ? new WeakEntry<K, V>(from.internals,
                        key, from.hash) : new LinkedWeakEntry<K, V>(
        ...
        SOFT {
            ...
            <K, V> ReferenceEntry<K, V> copyEntry(K key,
                ...
                return (newNext == null) ? new SoftEntry<K, V>(from.internals,
                        key, from.hash) : new LinkedSoftEntry<K, V>(
                        from.internals, key, from.hash, newNext);
            }
        },
        ...
        STRONG {
            ...
            <K, V> ReferenceEntry<K, V> newEntry(
                ...
                return (next == null) ? new StrongEntry<K, V>(internals, key,
                        hash) : new LinkedStrongEntry<K, V>(internals, key,
                        hash, next);
            }
