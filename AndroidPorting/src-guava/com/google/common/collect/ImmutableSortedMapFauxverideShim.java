 ...
 */
@GwtCompatible
abstract class ImmutableSortedMapFauxverideShim<K, V> extends
        ImmutableMap<K, V> {
    private static final long serialVersionUID = 6440955643384999724L;
     ...
     * non-{@code Comparable} key.</b> Proper calls will resolve to the version
     ...
     *             {@link ImmutableSortedMap#of(Comparable, Object, Comparable, Object)}
     *             .</b>
     */
    @Deprecated
     ...
     *             always
     * @deprecated <b>Pass keys of type {@code Comparable} to use
     *             {@link ImmutableSortedMap#of(Comparable, Object, Comparable, Object, Comparable, Object)}
     *             .</b>
     */
    @Deprecated
    public static <K, V> ImmutableSortedMap<K, V> of(K k1, V v1, K k2, V v2,
     ...
     *             always
     * @deprecated <b>Pass keys of type {@code Comparable} to use
     *             {@link ImmutableSortedMap#of(Comparable, Object, Comparable, Object, Comparable, Object, Comparable, Object)}
     *             .</b>
     */
    @Deprecated
    public static <K, V> ImmutableSortedMap<K, V> of(K k1, V v1, K k2, V v2,
     ...
     *             always
     * @deprecated <b>Pass keys of type {@code Comparable} to use
     *             {@link ImmutableSortedMap#of(Comparable, Object, Comparable, Object, Comparable, Object, Comparable, Object, Comparable, Object)}
     *             .</b>
     */
    @Deprecated
    public static <K, V> ImmutableSortedMap<K, V> of(K k1, V v1, K k2, V v2,
