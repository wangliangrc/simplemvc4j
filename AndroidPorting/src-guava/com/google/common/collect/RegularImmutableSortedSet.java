...
/**
 * An immutable sorted set with one or more elements. TODO: Consider creating a
...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    @Override
    public int hashCode() {
        // not caching hash code since it could change if the elements are
        // mutable
    ...
    ImmutableSortedSet<E> subSetImpl(E fromElement, E toElement) {
        return createSubset(findSubsetIndex(fromElement),
                findSubsetIndex(toElement));
    }
    ...
    int indexOf(Object target) {
        ...
        // with
        // equals().
        return (position >= 0 && elements[position].equals(target)) ? position
                - fromIndex : -1;
    }
