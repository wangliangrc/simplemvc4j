 ...
 * return a {@link Set} of values, while {@link #entries} returns a {@code Set}
 * of map entries. Though the method signature doesn't say so explicitly, the
 * map returned by {@link #asMap} has {@code Set} values.
 * 
 * @author Jared Levy
