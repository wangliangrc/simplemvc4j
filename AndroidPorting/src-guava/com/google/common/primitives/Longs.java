...
public final class Longs {
     ...
     * array; equivalent to
     * {@code ByteBuffer.allocate(8).putLong(value).array()}. For example, the
     * input value {@code 0x1213141516171819L} would yield the byte array
     ...
     * in the first 8 bytes of {@code bytes}; equivalent to
     * {@code ByteBuffer.wrap(bytes).getLong()}. For example, the input byte
     * array {@code 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19} would yield
