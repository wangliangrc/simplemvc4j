...
public final class Shorts {
     ...
     * array; equivalent to
     * {@code ByteBuffer.allocate(?).putShort(value).array()}. For example, the
     * input value {@code ?} would yield the byte array {@code ?} .
     * 
     * <p>
     ...
     * in the first ? bytes of {@code bytes}; equivalent to
     * {@code ByteBuffer.wrap(bytes).getShort()}. For example, the input byte
     * array {@code ?} would yield the {@code short} value {@code ?}.
     * 
     * <p>
