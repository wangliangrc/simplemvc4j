...
public interface Predicate<T> {
     ...
     * is also a {@code Predicate} and, for every input object {@code input}, it
     * returns exactly the same value. Thus,
     * {@code predicate1.equals(predicate2)} implies that either
     * {@code predicate1.apply(input)} and {@code predicate2.apply(input)} are
     * both {@code true} or both {@code false}.
     * 
     * <p>
     * Note that it is always safe <i>not</i> to override {@link Object#equals}.
     */
