...
public class LogSource {
    ...
    static {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger"))
                    && (null != Class
                            .forName("org.apache.commons.logging.impl.Jdk14Logger"))) {
     ...
     * class. The given class must implement {@link Log}, and provide a
     * constructor that takes a single {@link String} argument (containing the
     * name of the log).
     */
     ...
     * of <tt>org.apache.commons.logging.log</tt> may be set to the fully
     * specified name of a class that implements the {@link Log} interface. This
     * class must also have a public constructor that takes a single
     * {@link String} argument (containing the <i>name</i> of the {@link Log} to
     * be constructed.
     * <p>
     * When <tt>org.apache.commons.logging.log</tt> is not set, or when no
     * corresponding class can be found, this method will return a Log4JLogger
     * if the log4j Logger class is available in the {@link LogSource}'s
     * classpath, or a Jdk14Logger if we are on a JDK 1.4 or later system, or
    ...
    /**
     * Returns a {@link String} array containing the names of all logs known to
     * me.
     */
