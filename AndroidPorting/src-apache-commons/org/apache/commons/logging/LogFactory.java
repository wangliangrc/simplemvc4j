 ...
 * @version $Revision: 399431 $ $Date: 2006-05-03 21:58:34 +0100 (Wed, 03 May
 *          2006) $
 */
...
public abstract class LogFactory {
     ...
     * </pre></code> to system error and then continue using a standard
     * Hashtable.
     * </p>
     * <p>
    ...
    private static final Hashtable createFactoryStore() {
        ...
        String storeImplementationClass = System
                .getProperty(HASHTABLE_IMPLEMENTATION_PROPERTY);
     ...
     * null.
     * <p>
     * Most/all code should call getContextClassLoader rather than calling this
     * method directly.
     * <p>
     ...
     *                if the java security policy forbids access to the context
     *                classloader from one of the classes in the current call
     *                stack.
     * @since 1.1
     */
            ...
            if (classLoader != null) {
                try {
                    ...
                    if (classLoader == thisClassLoader) {
                        ...
                        //
                        String msg = "The application has specified that a custom LogFactory implementation should be used but "
                                + "Class '"
                                + factoryClass
