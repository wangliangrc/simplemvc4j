...
public class MiscPEMGenerator implements PemObjectGenerator {
    ...
    public MiscPEMGenerator(Object obj, String algorithm, char[] password,
            SecureRandom random, Provider provider) {
        this.obj = obj;
    ...
    public MiscPEMGenerator(Object obj, String algorithm, char[] password,
            SecureRandom random, String provider)
    ...
    private PemObject createPemObject(Object o) throws IOException {
        ...
        if (o instanceof X509Certificate) {
            ...
            try {
                ...
                throw new PemGenerationException("Cannot encode object: "
                        + e.toString());
            }
            ...
            PrivateKeyInfo info = new PrivateKeyInfo(
                    (ASN1Sequence) ASN1Object.fromByteArray(((Key) o)
                            .getEncoded()));
            ...
            if (o instanceof RSAPrivateKey) {
                ...
                DSAParameter p = DSAParameter.getInstance(info.getAlgorithmId()
                        .getParameters());
            ...
            throw new PemGenerationException(
                    "unknown object passed - can't encode.");
        }
    ...
    private PemObject createPemObject(Object obj, String algorithm,
            char[] password, SecureRandom random) throws IOException {
        if (obj instanceof KeyPair) {
            return createPemObject(((KeyPair) obj).getPrivate(), algorithm,
                    password, random);
        }
        ...
        if (obj instanceof RSAPrivateCrtKey) {
            ...
            keyData = new DERSequence(v).getEncoded();
                ...
                && "ECDSA".equals(((PrivateKey) obj).getAlgorithm())) {
            type = "EC PRIVATE KEY";

            PrivateKeyInfo privInfo = PrivateKeyInfo.getInstance(ASN1Object
                    .fromByteArray(((PrivateKey) obj).getEncoded()));
        ...
        byte[] encData = PEMUtilities.crypt(true, provider, keyData, password,
                dekAlgName, iv);
    ...
    public PemObject generate() throws PemGenerationException {
        try {
            ...
            throw new PemGenerationException("encoding exception: "
                    + e.getMessage(), e);
        }
    }
}
