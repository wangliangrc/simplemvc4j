...
public class OpenSSLDigest implements ExtendedDigest {
    ...
    /**
     * Holds a pointer to the native message digest context. It is lazily
     * initialized to avoid having to reallocate on reset when its unlikely to
     * be reused.
     */
    private int ctx;
    ...
    public static class MD5 extends OpenSSLDigest {
        private static final int EVP_MD = NativeCrypto
