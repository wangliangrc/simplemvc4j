...
public abstract class ECCurve {
        ...
        public ECPoint decodePoint(byte[] encoded) {
            ...
            // infinity
                ...
                case 0x03:
                    ...
                    ECFieldElement x = new ECFieldElement.Fp(this.q,
                            new BigInteger(1, i));
                    ...
                    if (bit0 == ytilde) {
                        ...
                        p = new ECPoint.Fp(this, x, new ECFieldElement.Fp(
                                this.q, q.subtract(beta.toBigInteger())), true);
                    }
                    break;
                // uncompressed
                case 0x04:
                ...
                case 0x07:
                    ...
                    System.arraycopy(encoded, xEnc.length + 1, yEnc, 0,
                            yEnc.length);

                    p = new ECPoint.Fp(this, new ECFieldElement.Fp(this.q,
                            new BigInteger(1, xEnc)), new ECFieldElement.Fp(
                            this.q, new BigInteger(1, yEnc)));
                    break;
                default:
                    throw new RuntimeException("Invalid point encoding 0x"
    ...
    public static class F2m extends ECCurve {
            ...
            // infinity
                ...
                case 0x07:
                    ...
                    p = new ECPoint.F2m(this,
                            new ECFieldElement.F2m(this.m, this.k1, this.k2,
                                    this.k3, new BigInteger(1, xEnc)),
                            new ECFieldElement.F2m(this.m, this.k1, this.k2,
                                    this.k3, new BigInteger(1, yEnc)), false);
                    break;
        ...
        private ECPoint decompressPoint(byte[] xEnc, int ypBit) {
            ECFieldElement xp = new ECFieldElement.F2m(this.m, this.k1,
                    this.k2, this.k3, new BigInteger(1, xEnc));
