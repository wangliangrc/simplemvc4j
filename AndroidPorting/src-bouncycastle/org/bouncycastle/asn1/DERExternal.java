...
public class DERExternal extends ASN1Object {
    ...
    public DERExternal(DERObjectIdentifier directReference,
            DERInteger indirectReference, ASN1Object dataValueDescriptor,
            DERTaggedObject externalData) {
        this(directReference, indirectReference, dataValueDescriptor,
                externalData.getTagNo(), externalData.getDERObject());
    }
    ...
    public DERExternal(DERObjectIdentifier directReference,
            DERInteger indirectReference, ASN1Object dataValueDescriptor,
            int encoding, DERObject externalData) {
    ...
    void encode(DEROutputStream out) throws IOException {
        ...
        out.writeEncoded(DERTags.CONSTRUCTED, DERTags.EXTERNAL,
                baos.toByteArray());
    }
     ...
     * 
     * @see
     * org.bouncycastle.asn1.ASN1Object#asn1Equals(org.bouncycastle.asn1.DERObject
     * )
     */
