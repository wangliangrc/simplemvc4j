...
public class X509Name extends ASN1Encodable {
     ...
     * RFC 2256 dmdName
     */
    public static final DERObjectIdentifier DMD_NAME = new DERObjectIdentifier(
            "2.5.4.54");
    ...
    public X509Name(ASN1Sequence seq) {
        ...
        while (e.hasMoreElements()) {
            ASN1Set set = ASN1Set.getInstance(((DEREncodable) e.nextElement())
                    .getDERObject());
    ...
    private String canonicalize(String s) {
        ...
        if (value.length() > 0 && value.charAt(0) == '#') {
            ...
            if (obj instanceof DERString) {
                value = Strings.toLowerCase(((DERString) obj).getString()
                        .trim());
            }
        }
