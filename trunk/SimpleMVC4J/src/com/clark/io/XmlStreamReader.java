...
public class XmlStreamReader extends Reader {
     ...
     *             thrown if there is a problem reading the stream.
     */
    private String doRawStream(BOMInputStream bom, BOMInputStream pis,
            boolean lenient) throws IOException {
     ...
     *             thrown if there is a problem reading the stream.
     */
    private String doHttpStream(BOMInputStream bom, BOMInputStream pis,
            String httpContentType, boolean lenient) throws IOException {
        String bomEnc = bom.getBOMCharsetName();
        String xmlGuessEnc = pis.getBOMCharsetName();
        String xmlEnc = getXmlProlog(pis, xmlGuessEnc);
        try {
        ...
        if (httpContentType != null && httpContentType.startsWith("text/html")) {
            ...
            try {
                return calculateHttpEncoding(httpContentType,
                        ex.getBomEncoding(), ex.getXmlGuessEncoding(),
                        ex.getXmlEncoding(), true);
    ...
    String calculateRawEncoding(String bomEnc, String xmlGuessEnc, String xmlEnc)
        ...
        String msg = MessageFormat.format(RAW_EX_2, new Object[] { bomEnc,
                xmlGuessEnc, xmlEnc });
     ...
     *             thrown if there is a problem reading the stream.
     */
    String calculateHttpEncoding(String httpContentType, String bomEnc,
            String xmlGuessEnc, String xmlEnc, boolean lenient)
            throws IOException {
        ...
        if (!appXml && !textXml) {
            String msg = MessageFormat.format(HTTP_EX_3, cTMime, cTEnc, bomEnc,
                    xmlGuessEnc, xmlEnc);
        ...
        if (cTEnc.equals(UTF_16BE) || cTEnc.equals(UTF_16LE)) {
            if (bomEnc != null) {
                String msg = MessageFormat.format(HTTP_EX_1, cTMime, cTEnc,
                        bomEnc, xmlGuessEnc, xmlEnc);
                throw new XmlStreamReaderException(msg, cTMime, cTEnc, bomEnc,
                        xmlGuessEnc, xmlEnc);
            }
        ...
        if (cTEnc.equals(UTF_16)) {
            ...
            String msg = MessageFormat.format(HTTP_EX_2, cTMime, cTEnc, bomEnc,
                    xmlGuessEnc, xmlEnc);
            throw new XmlStreamReaderException(msg, cTMime, cTEnc, bomEnc,
                    xmlGuessEnc, xmlEnc);
        }
    ...
    static boolean isAppXml(String mime) {
        return mime != null
                && (mime.equals("application/xml")
                        ...
                        || mime.equals("application/xml-external-parsed-entity") || (mime
