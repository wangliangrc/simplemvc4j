...
public abstract class AndroidWorker<Params, Progress, Result> {
    private static final String LOG_TAG = "AndroidWorker";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AndroidWorker #" + mCount.getAndIncrement());
        }
    };
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link AndroidWorker#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *            The parameters of the task.
     * 
     * @return This instance of AndroidWorker.
     * 
     * @throws IllegalStateException
     *             If {@link #getStatus()} returns either
     *             {@link AndroidWorker.Status#RUNNING} or
     *             {@link AndroidWorker.Status#FINISHED}.
     */
    public final AndroidWorker<Params, Progress, Result> execute(
            Params... params) {
     ...
     *             {@link AndroidWorker.Status#FINISHED}.
     */
    public final AndroidWorker<Params, Progress, Result> executeOnExecutor(
