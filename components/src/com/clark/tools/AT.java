...
public abstract class AT<Params, Progress, Result> {
    static final String TAG = AT.class.getSimpleName();
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AT #" + mCount.getAndIncrement());
        }
    };
     ...
     */
    public final AT<Params, Progress, Result> execute(Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(AT<?, ?, ?> task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
