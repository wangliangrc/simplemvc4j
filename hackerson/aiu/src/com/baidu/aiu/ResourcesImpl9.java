 ...
 * @version 1.0 13-4-9
 */
final class ResourcesImpl9 implements FixedResources {

    public static final ResourcesImpl9 INSTANCE = new ResourcesImpl9();
    ...
    public void setResource(Application application, String path) {
        try {
            ...
            Class apkClass = null;
            apkClass = Class.forName("android.app.LoadedApk");
