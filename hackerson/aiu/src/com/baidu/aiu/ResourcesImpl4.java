...
public class ResourcesImpl4 implements FixedResources {
    public static final ResourcesImpl4 INSTANCE = new ResourcesImpl4();
    ...
    public void setResource(Application application, String path) {
        try {
            ...
            implClass = Class.forName("android.app.ApplicationContext");
    ...
    public static void showResource(Context context) {
        try {
            ...
            Class apkClass = null;
            apkClass = Class.forName("android.app.ApplicationContext$PackageInfo");
            Field a = apkClass.getDeclaredField("mResDir");
            a.setAccessible(true);
