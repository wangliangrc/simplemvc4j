...
public abstract class LineReaderInputStream extends FilterInputStream {
     ...
     * @param dst
     *            Destination
     * @return number of bytes copied or <code>-1</code> if the end of the
     *         stream has been reached.
     * 
     * @throws MaxLineLimitException
     *             if the line exceeds a limit on the line length imposed by a
     *             subclass.
     * @throws IOException
     ...
     * 
     * Implementations will directly use the byte array backed by buf, so make
     * sure to not alter it anymore once this method has been called.
     * 
