...
/**
 * Enumeration of states an entity is expected to go through in the process of
 * the MIME stream parsing.
 */
public enum EntityState {
    /**
     * This token indicates, that the MIME stream is currently at the beginning
     * of a message.
     */
    T_START_MESSAGE,
    /**
     * This token indicates, that the MIME stream is currently at the end of a
     * message.
     */
    T_END_MESSAGE,
    /**
    ...
    T_BODY,
    /**
     * This token indicates, that the MIME stream has been completely and
     * successfully parsed, and no more data is available.
     */
    T_END_OF_STREAM
