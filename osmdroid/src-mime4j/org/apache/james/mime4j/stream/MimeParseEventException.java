...
/**
 * Indicates that strict parsing has been enabled and an optional invality has
 * been found in the input. {@link #getEvent()} indicates the type of
 * invalidity.
 */
public class MimeParseEventException extends MimeException {
     ...
     * 
     * @param event
     *            <code>MimeTokenStream.Event</code>, not null
     */
