...
/**
 * Raw MIME entity. Such entities will not be parsed into elements by the
 * parser. They are meant to be consumed as a raw data stream by the caller.
 */
public class RawEntity implements EntityStateMachine {
    ...
    public InputStream getDecodedContentStream() throws IllegalStateException {
        throw new IllegalStateException(
                "Raw entity does not support stream decoding");
    }
