 ...
 * Implement this interface and register an instance of that implementation with
 * a <code>MimeStreamParser</code> instance using its
 ...
 * basic message-related events like the start and end of the body of a part in
 ...
 * <p>
 * Events will be generated in the order the corresponding elements occur in the
 * message stream parsed by the parser. E.g.:
 * 
 * <pre>
 *      startMessage()
 *          startHeader()
 ...
 * </pre>
 * 
 * The above shows an example of a MIME message consisting of a multipart body
 * containing two body parts.
 * </p>
 * <p>
...
public interface ContentHandler {
    ...
    /**
     * Called when a new body part starts inside a <code>multipart/*</code>
     * entity.
     * 
     * @throws MimeException
     *             on processing errors
     ...
     * 
     * @param bd
     *            encapsulates the values (either read from the message stream
     *            or, if not present, determined implictly as described in the
    ...
    /**
     * Called when the body of a discrete (non-multipart) entity is about to be
     * parsed.
     * 
     * @param bd
     *            see {@link #startMultipart(BodyDescriptor)}
     * @param is
     ...
     *             should be thrown on I/O errors.
     */
    void body(BodyDescriptor bd, InputStream is) throws MimeException,
            IOException;

    /**
     * Called when a new entity (message or body part) starts and the parser is
