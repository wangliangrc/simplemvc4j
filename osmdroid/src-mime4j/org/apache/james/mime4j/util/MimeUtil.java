...
public final class MimeUtil {
     ...
     */
    /*
     * TODO - From rfc2045: Since the hyphen character ("-") may be represented
     * as itself in the Quoted-Printable encoding, care must be taken, when
     * encapsulating a quoted-printable encoded body inside one or more
     * multipart entities, to ensure that the boundary delimiter does not appear
     * anywhere in the encoded body. (A good strategy is to choose a boundary
     * that includes a character sequence such as "=_" which can never appear in
     * a quoted-printable body. See the definition of multipart messages in RFC
     * 2046.)
     */
