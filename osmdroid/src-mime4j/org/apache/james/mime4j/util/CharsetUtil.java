...
public class CharsetUtil {
    ...
    /**
     * Returns <code>true</code> if the specified string consists entirely of US
     * ASCII characters.
     * 
     * @param s
     *            string to test.
     * @return <code>true</code> if the specified string consists entirely of US
     *         ASCII characters, <code>false</code> otherwise.
     */
