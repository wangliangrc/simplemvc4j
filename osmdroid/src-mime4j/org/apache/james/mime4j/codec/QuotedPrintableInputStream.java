...
public class QuotedPrintableInputStream extends InputStream {
    ...
    protected QuotedPrintableInputStream(final int bufsize,
            final InputStream in, DecodeMonitor monitor) {
        super();
        this.in = in;
    ...
    protected QuotedPrintableInputStream(final int bufsize,
            final InputStream in, boolean strict) {
    ...
    /**
     * Terminates Quoted-Printable coded content. This method does NOT close the
    ...
    private int transfer(final int b, final byte[] buffer, final int from,
            final int to, boolean keepblanks) throws IOException {
        int index = from;
        ...
        while (index < to) {
            ...
            while (pos < limit && index < to) {
                ...
                if (lastWasCR && b != LF) {
                    ...
                    if (monitor.warn("Found LF without CR",
                            "Translating to CRLF"))
