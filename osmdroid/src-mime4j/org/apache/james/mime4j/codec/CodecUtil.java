...
public class CodecUtil {
    ...
    /**
     * Encodes the given stream using Quoted-Printable. This assumes that stream
     * is binary and therefore escapes all line endings.
     * 
     * @param in
     *            not null
     * @param out
     ...
     * @throws IOException
     */
    public static void encodeQuotedPrintableBinary(final InputStream in,
            final OutputStream out) throws IOException {
        QuotedPrintableOutputStream qpOut = new QuotedPrintableOutputStream(
                out, true);
        copy(in, qpOut);
        qpOut.close();
    }
    ...
    /**
     * Encodes the given stream using Quoted-Printable. This assumes that stream
     * is text and therefore does not escape all line endings.
     * 
     * @param in
     *            not null
     * @param out
     ...
     * @throws IOException
     */
    public static void encodeQuotedPrintable(final InputStream in,
            final OutputStream out) throws IOException {
        QuotedPrintableOutputStream qpOut = new QuotedPrintableOutputStream(
                out, false);
        copy(in, qpOut);
     ...
     */
    public static void encodeBase64(final InputStream in, final OutputStream out)
            throws IOException {
     ...
     * @throws IOException
     */
    public static OutputStream wrapQuotedPrintable(final OutputStream out,
     ...
     * @throws IOException
     */
    public static OutputStream wrapBase64(final OutputStream out)
            throws IOException {
