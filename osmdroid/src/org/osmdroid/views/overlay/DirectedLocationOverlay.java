...
public class DirectedLocationOverlay extends Overlay {
    ...
    public DirectedLocationOverlay(final Context ctx,
        ...
        this.DIRECTION_ARROW = mResourceProxy
        ...
        if (this.mLocation != null) {
            ...
            if (this.mShowAccuracy && this.mAccuracy > 10) {
                final float accuracyRadius = pj
                        .metersToEquatorPixels(this.mAccuracy);
                ...
                if (accuracyRadius > 8) {
                    ...
                    c.drawCircle(screenCoords.x, screenCoords.y,
                            accuracyRadius, this.mAccuracyPaint);
             ...
             */
            this.directionRotater.setRotate(this.mBearing,
            ...
            c.drawBitmap(rotatedDirection,
                    ...
                    screenCoords.y - rotatedDirection.getHeight() / 2,
                    this.mPaint);
        }
    }
