...
#define HAVE_SQLITE3_BACKUPAPI 1
#define HAVE_SQLITE3_INCRBLOBIO 1
#define HAVE_SQLITE3_OPEN_V2 1
#define HAVE_SQLITE3_LOAD_EXTENSION 1
#define HAVE_SQLITE3_RESULT_ZEROBLOB 1
#define HAVE_SQLITE3_BIND_ZEROBLOB 1
#define HAVE_SQLITE_SET_AUTHORIZER 1
#define HAVE_SQLITE3_PREPARE_V2 1
#define HAVE_SQLITE3_PREPARE16_V2 1
#define HAVE_SQLITE3_CLEAR_BINDINGS 1
#define HAVE_SQLITE3_BIND_PARAMETER_NAME 1
#define HAVE_SQLITE3_BIND_PARAMETER_INDEX 1
//#define HAVE_SQLITE3_COLUMN_TABLE_NAME16 1
//#define HAVE_SQLITE3_COLUMN_DATABASE_NAME16 1
//#define HAVE_SQLITE3_COLUMN_ORIGIN_NAME16 1
#define HAVE_SQLITE3_STMT_STATUS 1
//#define HAVE_SQLITE3_KEY 1
#define HAVE_SQLITE3_SHARED_CACHE 1
#define HAVE_SQLITE3_PROFILE 1
#define HAVE_SQLITE3_STATUS 1
#define HAVE_SQLITE3_DB_STATUS 1
...
static int busyhandler3(void *udata, int count) {
    ...
    if (env && h->bh) {
        ...
        ret = (*env)->CallBooleanMethod(env, h->bh, mid, 0,
                (jint) count) != JNI_FALSE;
        (*env)->DeleteLocalRef(env, cls);
    }
    return ret;
}
...
Java_SQLite_Stmt_prepare(JNIEnv *env, jobject obj) {
    ...
    if (v && v->h && v->h->sqlite) {
        ...
        ret = sqlite3_prepare16_v2((sqlite3 *) v->h->sqlite,
                ...
                (const void **) &tail);
#else
        ret = sqlite3_prepare16((sqlite3 *) v->h->sqlite, v->tail, -1,
...
#endif
    F_SQLite_Database_handle = (*env)->GetFieldID(env, cls, "handle", "J");
    F_SQLite_Database_error_code = (*env)->GetFieldID(env, cls, "error_code",
            "I");
